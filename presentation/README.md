...
- `slides.pdf`: Complete 8-slide deck covering:
  ...
  4. Technical Architecture: Telemetry to IBM Bob Copilot
  5. Machine Learning Pipeline & Anti-Leakage Methodology
  6. Explainable Readiness & Prioritized Maintenance
  7. IBM Bob Copilot Integration & 3 Core Queries
  8. Operational Impact & Hackathon Summary
